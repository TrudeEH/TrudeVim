...
local on_attach = function(_, _)
  vim.keymap.set('n', '<leader>rn', vim.lsp.buf.rename, { desc = "Rename all definitions"})
  vim.keymap.set('n', '<Leader>ca', vim.lsp.buf.code_action, { desc = "Code Actions" })

  vim.keymap.set('n', 'gd', vim.lsp.buf.definition, { desc = "Jump to the definition of the symbol under the cursor" })
  vim.keymap.set('n', 'gi', vim.lsp.buf.implementation, { desc = "Implementation" })
  vim.keymap.set('n', 'gr', require('telescope.builtin').lsp_references, { desc = "References of functions" })
...
-- Select + gc -> Comment multiple lines
...
-- Custom commands (: command) to automate terminal actions
